/*********************************************************************
KCReportThread.h - Wrapper thread

Copyright (c) 2009 - opcoders.com
Simon Strandgaard <simon@opcoders.com>
*********************************************************************/
#ifndef __OPCODERS_KEYBOARDCOMMANDER_REPORT_THREAD_H__
#define __OPCODERS_KEYBOARDCOMMANDER_REPORT_THREAD_H__

@protocol ReportChildProtocol;
@class KCReportParent;

@interface KCReportThread : NSObject {
	/*
	...
	*/
	...
	NSTask* m_task;
	KCReportParent* m_root_object;
	NSConnection* m_connection;

	NSString* m_child_name;
	id <ReportChildProtocol> m_child;
...
@interface NSObject (KCReportThreadDelegate)
-(void)nowProcessingRequest;
-(void)hasData:(NSData*)data;
@end


#endif // __OPCODERS_KEYBOARDCOMMANDER_REPORT_THREAD_H__