...
- (NSAttributedString *)attributedStringValue {
    if (![_controlView isKindOfClass:[PSMTabBarControl class]]) {
        return nil;
    }
    PSMTabBarControl *psmTabBarControl = (PSMTabBarControl*)_controlView;
	return [(id < PSMTabStyle >)[psmTabBarControl style] attributedStringValueForTabCell:self];
}
...
- (NSRect)indicatorRectForFrame:(NSRect)cellFrame {
    ...
    PSMTabBarControl *psmTabBarControl = (PSMTabBarControl*)_controlView;
	return [(id < PSMTabStyle >)[psmTabBarControl style] indicatorRectForTabCell:self];
}
...
- (NSRect)closeButtonRectForFrame:(NSRect)cellFrame {
    ...
    PSMTabBarControl *psmTabBarControl = (PSMTabBarControl*)_controlView;
	return [(id < PSMTabStyle >)[psmTabBarControl style] closeButtonRectForTabCell:self withFrame:cellFrame];
}
...
- (CGFloat)minimumWidthOfCell {
    ...
    PSMTabBarControl *psmTabBarControl = (PSMTabBarControl*)_controlView;
	return [(id < PSMTabStyle >)[psmTabBarControl style] minimumWidthOfTabCell:self];
}
...
- (CGFloat)desiredWidthOfCell {
    ...
    PSMTabBarControl *psmTabBarControl = (PSMTabBarControl*)_controlView;
	return [(id < PSMTabStyle >)[psmTabBarControl style] desiredWidthOfTabCell:self];
}
...
- (void)drawWithFrame:(NSRect)cellFrame inView:(NSView *)controlView {
    ...
    PSMTabBarControl *psmTabBarControl = (PSMTabBarControl*)_controlView;
	[(id < PSMTabStyle >)[psmTabBarControl style] drawTabCell:self];
}
